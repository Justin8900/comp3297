...
class AccommodationSerializer(serializers.ModelSerializer):
    ...
    owner_id = serializers.PrimaryKeyRelatedField(
        ...
        source='owner',
        required=True, 
        label="Existing Property Owner ID" 
    )
    ...
    available_at_universities = serializers.SlugRelatedField(
         ...
         slug_field='code',
         many=True,
         label="Universities offering this accommodation (use codes like 'HKU', 'CU')" 
    )
...
class RatingSerializer(serializers.ModelSerializer):
    ...
    reservation = serializers.PrimaryKeyRelatedField(
        ...
        label="Reservation ID being rated" 
    )
...
class ReservationSerializer(serializers.ModelSerializer):
    ...
    member_uid = serializers.CharField(
         write_only=True, 
         required=False, 
         label="Member UID (Required if Specialist is creating reservation)" 
    )
